...
add_arg('image_dir',           str,    '../../data/train/train',               '图片存放的路径')
add_arg('train_anno_path',     str,    '../train_all.json',     '训练数据标注信息json文件路径')
add_arg('eval_anno_path',      str,    '../train_all.json',      '评估标注信息json文件路径')
